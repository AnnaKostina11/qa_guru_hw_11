...
def test_student_registration_form(setup_browser):
 ...
 filling_gender(browser)
 filling_mobile(browser)
 filling_date(browser)
 filling_subjects(browser)
 filling_hobbies(browser)
 filling_picture(browser)
 filling_address(browser)
 filling_state(browser)
 filling_city(browser)
